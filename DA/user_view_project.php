...
.gantt-wrapper .task-list::-webkit-scrollbar,
.gantt-wrapper .timeline-content::-webkit-scrollbar {
    width: 6px;
    height: 6px;
}

.gantt-wrapper .task-list::-webkit-scrollbar-track,
.gantt-wrapper .timeline-content::-webkit-scrollbar-track {
    background: #f1f1f1;
}

.gantt-wrapper .task-list::-webkit-scrollbar-thumb,
.gantt-wrapper .timeline-content::-webkit-scrollbar-thumb {
    background: #c1c1c1;
    border-radius: 3px;
}

.gantt-wrapper .task-list::-webkit-scrollbar-thumb:hover,
.gantt-wrapper .timeline-content::-webkit-scrollbar-thumb:hover {
    background: #a8a8a8;
}

/* Responsive adjustments */
@media (max-width: 768px) {
    .gantt-wrapper .task-list {
        width: 150px;
        min-width: 150px;
    }
    
    .gantt-wrapper .task-list div {
        padding: 10px 8px;
        font-size: 12px;
    }
}
                        ...
                        <div class="modal fade" id="assignTaskModal" tabindex="-1" aria-labelledby="assignTaskModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form id="assignTaskForm" action="user_assign_task.php" method="POST" enctype="multipart/form-data">
